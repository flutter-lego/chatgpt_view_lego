...
[![pub package](https://img.shields.io/pub/v/chatgpt_view_lego.svg)](https://pub.dartlang.org/packages/chatgpt_view_lego)
...
# chatgpt_view_lego
<img src="https://github.com/user-attachments/assets/757be8fb-0bbb-485a-bdbc-d2dc4a7ce615" width="200" alt="toss_intro_page_lego">
...
2. To add Lego to your project, enter the following command in the terminal at the root of your project:
   ```bash
   lego add chatgpt_view_lego
   ```
3. run the following command to generate the widget: 
    ```bash
    flutter run -d chrome lib/widget_book/chatgpt_view_lego/_/_.dart
    ```
